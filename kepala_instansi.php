...
class Kepala_instansi extends CI_Controller {
  ...
  {   
    ...
    $data["data"] = getKepala($id_opd)["data"][0];
    ...
    if (theme_folder() == "default") {
        $data['contentType'] = 'foprofil/content-type-kepala_instansi';
        ...
        $this->frontend->createView('foprofil/kepala_instansi', $data, true);
    }
  }
