...
class Free_hotspot extends CI_Controller {
  ...
  {   
    ...
    $data["data"] = getFreehotspot($kelurahan->nama_kel)["data"];
    ...
    if (theme_folder() == "default") {
        $data['contentType'] = 'foprofil/content-type-free_hotspot';
        ...
        $this->frontend->createView('foprofil/free_hotspot', $data, true);
    }
  }
