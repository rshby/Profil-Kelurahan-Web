...
class Rthp extends CI_Controller {
  ...
  {   
    ...
    $data["data"] = getRTHP($kelurahan->nama_kel)["data"];
    ...
    if (theme_folder() == "default") {
        $data['contentType'] = 'foprofil/content-type-rthp';
        ...
        $this->frontend->createView('foprofil/rthp', $data, true);
    }
  }
