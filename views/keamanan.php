...
<div class="col-lg-8 <?=$order?> feature_area">
    ...
    <div class="data-table mt-3">
        ...
        <table class="table bstable table-bordered" id="table-statistik-warga" data-url="<?=base_url('profil/keamanan/getDTData/');?>" data-pagination="false" data-locale="id-ID" data-sort-order="desc" data-row-style="rowStyle">
            <thead>
                <tr>
                    <?php
                        if ($stacked || $grouped) {
                    ...
                    ?>
                    <th data-field="selisih" data-sortable="true" data-align="right">Selisih</th>
                </tr>
            </thead>
        </table>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $.ajax({
            url: "<?= base_url('profil/keamanan/getChartData/');?>",
            method: "GET",
            timeout: 600000,
